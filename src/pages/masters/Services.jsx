              ...
              <tr className="text-white text-center">
                ...
                {visibleColumns.name && (
                 ...
                 {visibleColumns.charge && (
                  <SortableHeader
                    label="Charge"
                    sortOrder={sortConfig.key === "charge" ? sortConfig.direction : null}
                 ...
                 {visibleColumns.tax && (
                  <SortableHeader
                    label="Tax (%)"
                    sortOrder={sortConfig.key === "tax" ? sortConfig.direction : null}
            ...
            <tbody className="text-center">
              ...
              {sortedRows.map((row) => (
                ...
                >
                  ...
                  {visibleColumns.charge && (
                    <td className="px-2 py-1 align-middle">{row.charge}</td>
                  )}
                  {visibleColumns.description && (
                    <td className="px-2 py-1 align-middle">{row.description}</td>
                  )}
                  {visibleColumns.tax && (
                    <td className="px-2 py-1 align-middle">{row.tax}</td>
                  )}
                </tr>
              ))}

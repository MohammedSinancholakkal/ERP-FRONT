...
const FilterBar = ({ filters = [], onClear, className = "" }) => {
  return (
    <div className={`flex flex-wrap items-center gap-2 bg-gray-900 p-3 rounded-md border border-gray-700 ${className}`}>
      ...
      {onClear && (
        <div className="flex items-end self-end pb-0.5">
            <button 
                onClick={onClear} 
                className="text-white hover:text-gray-200 flex items-center gap-1 text-sm bg-gray-700 px-3 py-1.5 rounded border border-gray-600 hover:bg-gray-600 transition-colors"

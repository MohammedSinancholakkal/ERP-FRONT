...
const Footer = () => {
  ...
  return (
    <footer className="w-full bg-gray-900 border-t border-gray-700 text-white py-1 px-5 text-sm flex justify-between items-center border-t border-gray-800/50 -mt-3">
